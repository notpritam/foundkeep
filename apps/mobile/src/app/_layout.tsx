...
export default function RootLayout() {
  ...
  return <ThemeProvider value={theme}><SessionProvider><MotionProvider><MaterialProvider><StatusBar style="auto" /><NavigationController /><Stack screenOptions={{ headerShown: false, contentStyle: { backgroundColor: colors.paper }, animation: 'fade' }} /></MaterialProvider></MotionProvider></SessionProvider></ThemeProvider>;
}
