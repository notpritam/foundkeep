...
const styles = StyleSheet.create({ page: { flexGrow: 1, padding: 24, gap: 28 }, heading: { marginTop: 24, gap: 12 }, code: { padding: 18, borderWidth: 1, borderColor: colors.accent, borderRadius: 20, backgroundColor: colors.surface }, codeText: { color: colors.ink, fontSize: 17, lineHeight: 26, fontFamily: 'monospace' }, actions: { marginTop: 'auto', gap: 12 } });
